    ...
    return (
        <div className="container1">
            ...
            <section className="project-overview">
                <h2>프로젝트 개요</h2>
                <p className="project1-p">기존 크리우드 펀딩 사이트 에서는 구매자와 판매자의 소통창구가 부족하다고 느꼈습니다. <br/> 크라우드 펀딩은 펀딩 성공 여부로 제품을 받기
                    때문에 상품을 구매하고 펀딩이 성공할 때까지 과정을 알 수 있는 구매자와 판매자의 소통 공간의 필요성을 느껴 게시판 기능이 있는 커뮤니티 크라우드 펀딩 사이트를 구현해보았습니다. </p>
                <ul>
            ...
            <section className="project-result">
                ...
                <p>
                    제가 맡은 부분은 로그인, 회원가입창과 마이페이지였습니다.
                    React만으로 제작한 첫 프로젝트라서 기초 세팅부터 라우팅, 상태 관리까지 모든 과정을 직접 구현해야 했습니다.
                    특히 React SPA 구조와 상태 관리를 직접 구현하면서 컴포넌트 분리와 재사용성의 중요성을 깊이 이해했고,
                    Props와 State를 어떻게 설계해야 유지보수가 쉬운지 체감했습니다.
                    또한 Git 브랜치를 활용해 팀원들과 병렬 개발을 진행하며
                    코드 충돌을 최소화하고 협업 효율을 높이는 방법을 익혔습니다.
                    이 경험을 통해 단순히 기능을 완성하는 것뿐 아니라
                    코드 품질과 협업 프로세스가 프로젝트 성공에 얼마나 큰 영향을 미치는지 배우게 되었습니다.
                </p>
            </section>
